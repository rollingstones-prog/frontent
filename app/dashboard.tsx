...
export default function WhatsAppDashboard() {
  ...
  const handleSendMessage = () => {
    ...
    // Update last message in employee list
    setEmployees((prev) =>
      prev.map((emp) =>
        ...
        <div className="p-2 md:p-4 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700"> 
          ...
          <div className="relative"> 
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500" 
            /> 
          </div> 
        </div> 
              ...
              <div className="flex items-center space-x-2"> 
                ...
                <div className="flex-1 relative"> 
                  <input 
                    ...
                    className="w-full px-4 py-2 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-full text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500" 
                  /> 
